<x-layout>
    ...
    <div class="bg-gray-100 min-h-screen">
        ...
        <div class="relative h-screen md:h-[40rem] lg:h-[50rem]">
          <img src="path/to/store-banner.jpg" alt="Store Banner" class="w-full h-full object-cover">
          <div class="absolute inset-0 bg-gradient-to-t from-black via-black/70 to-transparent"></div>

          <!-- Store information overlay -->
          <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
            <h1 class="text-4xl md:text-6xl font-bold mb-2">Store Name</h1>
            <p class="text-sm md:text-base mb-2">123 Store Street, City, Country</p>
            <p class="text-sm md:text-base mb-4 max-w-2xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            ...
            <div class="flex space-x-4 mb-4">
              <a href="#" target="_blank" class="text-white hover:text-blue-400 transition-colors">
              ...
              <a href="#" target="_blank" class="text-white hover:text-pink-400 transition-colors">
                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://wa.me/1234567890" target="_blank" class="text-white hover:text-green-400 transition-colors">
                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
